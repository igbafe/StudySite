      ...
      {isOpen && (
        ...
        <div className="course-buttons col-6">
          ...
          <button
            ...
            onClick={() => handleCourseButtonClick("CPE521")}
          >
            CPE531
          </button>
        ...
        <div className="video-section mt-1">
          <div className="row">
            <div className="col-md-6">
              ...
              <div className="row mt-3">
                <div className="col-md-4">
                  <iframe
                    src="https://www.youtube.com/embed/hJIST1cEf6A"
                ...
                <div className="col-md-4">
                  <iframe
                    src="https://www.youtube.com/embed/LOZxYBOKRLg"
            ...
            <h4>
              ...
              <h5>Digital System Design with VHDL</h5>
              <p>
                This is an introduction video to your course CPE 531(Digital System Design with VHDL) Access
